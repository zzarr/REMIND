                            ...
                            Promise.all(p).then((n) => {
                                ...
                                Array.from(r).forEach((e) => {
                                    ...
                                    (a = p ? p(i) : "string" == typeof i ? i.replace(/(\$|,|\s|%)/g, "") : i),
                                        parseFloat(a) == a ? (l[d++] = { value: Number(a), row: e }) : (h[o++] = { value: "string" == typeof i ? i.toLowerCase() : i, row: e });
                                }),
                                    e || (e = c.classList.contains("asc") ? "desc" : "asc"),
                                    "desc" == e ? ((u = a(h, -1)), (g = a(l, -1)), c.classList.remove("asc"), c.classList.add("desc")) : ((u = a(l, 1)), (g = a(h, 1)), c.classList.remove("desc"), c.classList.add("asc")),
